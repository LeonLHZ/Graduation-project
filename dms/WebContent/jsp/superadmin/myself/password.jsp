...
<body class="ContentBody">
  <form action="${pageContext.request.contextPath}/super?method=updatePassword" method="post"  name="form" >
<div class="MainDiv">
...
<script type="text/javascript">
		...
		$("#userAction_save_do_logonName").blur(function(){
			...
			var params = {"username":"${user.username}","oldpassword":old};
			$.post("${pageContext.request.contextPath}/super?method=checkPassword",params,function(data){
