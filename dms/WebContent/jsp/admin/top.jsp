...
document.write("&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp欢迎：${user.admin.name}&nbsp&nbsp&nbsp&nbsp工号：${user.admin.username}&nbsp&nbsp&nbsp&nbsp");
// -->
									</script> <span id="spanajax"></span></font>
							</td>
							<td width="15%">
								<table width="100%" border="0" cellspacing="0" cellpadding="0">
									<tr>
										...
										<td width="300" valign="bottom"
											background="${pageContext.request.contextPath}/images/mis_05b.jpg">
											<a href="${pageContext.request.contextPath }/login?method=logOut">退出登录</a>
	...
	$(function(){
		...
		$.post("${pageContext.request.contextPath}/admin?method=ajaxfindadmin",function(data){
			
			$("#spanajax").html("所管楼栋："+data.building.number+"栋&nbsp;&nbsp;&nbsp;&nbsp;现住人数: "+data.building.nowstudentnumber+"人&nbsp&nbsp&nbsp&nbsp可住人数："+data.building.studentnumber+"人");
		},"json");
	});
