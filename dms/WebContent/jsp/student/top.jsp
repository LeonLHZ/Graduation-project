...
document.write("&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp欢迎：${user.student.name}&nbsp&nbsp&nbsp&nbsp学号：${user.student.username}&nbsp&nbsp&nbsp&nbsp");
// -->
	...
	<script>
	$(function(){
	$.post("${pageContext.request.contextPath}/student?method=findMyDormitory",function(data){
		
			
			$("#spanajax").append(
				"所在楼栋："+data.building.number+"&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;您的宿舍号码："+data.dormitory.num+"&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;您的床位："+data.position.numbering
			);
