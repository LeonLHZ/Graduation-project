...
<body class="ContentBody">
  <form action="${pageContext.request.contextPath}/employer?method=updatePassword" method="post"  name="form" id="form">
<div class="MainDiv">
...
<script type="text/javascript">
	var flag = true;
		$("#userAction_save_do_logonName").blur(function(){
			...
			var params = {"eid":"${user.uid}","oldpassword":old};
			$.post("${pageContext.request.contextPath}/employer?method=checkPassword",params,function(data){
