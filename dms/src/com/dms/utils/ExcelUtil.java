...
public class ExcelUtil {
     ...
     * @throws Exception  
     */  
    public static List<User> AddStudentByExcel(Building building) throws Exception {  
    	List<User> list = new ArrayList<>();
        SimpleDateFormat fmt = new SimpleDateFormat("yyyy-MM-dd");  
        try {  
            // 同时支持Excel 2003、2007  
            File excelFile = new File("D:\\img\\excel.xlsx"); // 创建文件对象  
...
//                    }
                    ...
                    user.setType(Constant.STUDENT);
                    Date date = new Date();
                    student.setStarttime(date);
                    student.setBid(building.getBid());
                    ...
                    for (int i = 0; i < end; i++) {
                    	...
                    	//add
                    	if(i==0) {
                    		student.setUsername(obj.toString());
                    		user.setUsername(obj.toString());
                    	}
                    	if(i==1) {
                    		student.setName(obj.toString());
         
                    	}
                    	if(i==2) {
                    		
                    		student.setLevel(Integer.parseInt(obj.toString()));
         
                    	}
                    	
                       if(i==3) {
                    		
                    		student.setYear(Integer.parseInt(obj.toString()));
         
                    	}
                       if(i==4) {
                   		
                   		student.setMajor(obj.toString());
                       ...
                       if(i==6) {
                      		...
                      		student.setTelephone(obj.toString());
           
                      	}
                       if(i==7) {
                     		
                     		student.setTeacherphone(obj.toString());
